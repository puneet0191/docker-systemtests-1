...
RUN DEBIAN_FRONTEND='noninteractive' apt-get install -y zip mysql-server apache2 mysql-client php7.1 \
    php7.1-fpm php7.1-soap php7.1-cli php7.1-curl php7.1-gd php7.1-mysql php7.1- php7.1-zip php7.1-xml php7.1-intl php7.1-mbstring libapache2-mod-php7.1 curl \
